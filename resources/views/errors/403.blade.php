...
<p>> <span>SOME PAGES ON THIS SERVER THAT YOU DO HAVE PERMISSION TO ACCESS</span>: [<a href="{{ url('/dashboard') }}">Dashboard</a>, <a href="{{ url('/penilaian') }}">Penilaian</a>]</p><p>> <span>HAVE A NICE DAY SIR AXLEROD :-)</span></p>
</div>
